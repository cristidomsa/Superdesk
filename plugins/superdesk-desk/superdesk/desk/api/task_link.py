...
class ITaskLinkService(IEntityService):
    ...
    @call(method=GET)
    def getAll(self, typeKey:TaskLinkType.Name=None, detailed:bool=True,
               q:QTaskLink=None) -> Iter(TaskLink.Id):
        '''
        Provides all the available task links.
        '''

    @call(method=GET, webName='Head')
    def getHead(self, headId:Task.Id, typeKey:TaskLinkType.Name=None, detailed:bool=True,
               q:QTaskLink=None) -> Iter(TaskLink.Id):
        '''
    ...
    def getTail(self, tailId:Task.Id, typeKey:TaskLinkType.Name=None, detailed:bool=True,
               q:QTaskLink=None) -> Iter(TaskLink.Id):
        '''
    ...
    @call(method=GET)
    def getSide(self, sideId:Task.Id, typeKey:TaskLinkType.Name=None, detailed:bool=True,
               q:QTaskLink=None) -> Iter(TaskLink.Id):
        '''
